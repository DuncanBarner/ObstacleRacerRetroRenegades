...
public class Player2Movement : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if (Input.GetButtonDown("Player2Jump") && (isGrounded || jumpTimeCounter > 0 /*&& !OnWall()*/) && !PauseMenu.isPaused)
        {
        ...
        if (Input.GetButtonUp("Player2Jump") && isJumping && !isWallJumping)
        {
